...
You need to strictly follow the format in the following examples:\n"""
        ...
        self.task_embedding = torch.load("expert_actions/task_goal_embd_list.pt").to(
            self.device
        )
        self.observation_embedding = torch.load("expert_actions/obs_langs_embd_list.pt")
        self.act_lang_list = pickle.load(
            open("expert_actions/act_langs_list.pik", "rb")
        )
        self.task_lang_list = pickle.load(
            open("expert_actions/task_langs_list.pik", "rb")
        )
        self.obs_lang_list = pickle.load(
            open("expert_actions/obs_langs_list.pik", "rb")
        )
        self.prompt_buffer = {}
